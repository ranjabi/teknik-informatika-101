...
## Table of contents
  ...
  - [Semester 3](#semester-3)
    - [IF2121 Logika Komputasional](#if2121-logika-komputasional)
      - [Tugas Besar - Farm Simulation Role-Playing CLI Game in Prolog](#tugas-besar---farm-simulation-role-playing-cli-game-in-prolog)
    - [IF2110 Algoritma & Struktur Data](#if2110-algoritma--struktur-data)
      - [Tugas Besar - Command Line Interface (CLI) Game](#tugas-besar---command-line-interface-cli-game)
    ...
    - [IF2124 Teori Bahasa Formal dan Otomata](#if2124-teori-bahasa-formal-dan-otomata)
      - [Tugas Besar - Python Syntax Checker](#tugas-besar---python-syntax-checker)
    - [IF2123 Aljabar Linier dan Geometri](#if2123-aljabar-linier-dan-geometri)
      - [Tugas Besar 1 - Sistem Persamaan Linear, Matrix, Determinan, Interpolasi, dan Regresi Linear CLI Solver in Java](#tugas-besar-1---sistem-persamaan-linear-matrix-determinan-interpolasi-dan-regresi-linear-cli-solver-in-java)
      - [Tugas Besar 2 - Image Compression Website using Singular Value Decomposition (SVD) Algorithm](#tugas-besar-2---image-compression-website-using-singular-value-decomposition-svd-algorithm)
  ...
  - [Semester 4](#semester-4)
    - [IF2210 Pemrograman Berorientasi Objek](#if2210-pemrograman-berorientasi-objek)
      - [Tugas Besar - Minecraft CLI Game](#tugas-besar---minecraft-cli-game)
      - [Tugas Besar - GUI Minecraft Card Game](#tugas-besar---gui-minecraft-card-game)
    - [IF2211 Strategi Algoritma](#if2211-strategi-algoritma)
      - [Tugas Kecil 1 - Word Search Puzzle](#tugas-kecil-1---word-search-puzzle)
      - [Tugas Kecil 2 - Convex Hull Searching using Divide and Conquer](#tugas-kecil-2---convex-hull-searching-using-divide-and-conquer)
      - [Tugas Kecil 3 - 15 Puzzle Solver using Branch and Bound Algorithm](#tugas-kecil-3---15-puzzle-solver-using-branch-and-bound-algorithm)
      - [Tugas Besar 2 - Folder Crawler with Breadth First Search and Depth First Search](#tugas-besar-2---folder-crawler-with-breadth-first-search-and-depth-first-search)
      - [Tugas Besar 3 - DNA Pattern Matching Website using String Matching and Regular Expression](#tugas-besar-3---dna-pattern-matching-website-using-string-matching-and-regular-expression)
    - [IF2220 Probabilitas dan Statistika](#if2220-probabilitas-dan-statistika)
    - [IF2230 Sistem Operasi](#if2230-sistem-operasi)
      - [Tugas Besar - Simple 16-Bit Operating System](#tugas-besar---simple-16-bit-operating-system)
  ...
  - [Semester 5](#semester-5)
    ...
    - [IF3110 Pengembangan Aplikasi Berbasis Web](#if3110-pengembangan-aplikasi-berbasis-web)
      - [Tugas Besar 1 - Spotify Clone in PHP](#tugas-besar-1---spotify-clone-in-php)
      - [Tugas Besar 2 - Extended Spotify Clone with microservices, REST and SOAP API, ReactJS](#tugas-besar-2---extended-spotify-clone-with-microservices-rest-and-soap-api-reactjs)
    - [IF3130 Jaringan Komputer](#if3130-jaringan-komputer)
      - [Tugas Besar 2 - Implementasi jaringan TCP menggunakan UDP](#tugas-besar-2---implementasi-jaringan-tcp-menggunakan-udp)
    - [IF3141 Sistem Informasi](#if3141-sistem-informasi)
      - [Tugas Besar - Sistem Manajemen Perusahaan dengan Aplikasi Odoo](#tugas-besar---sistem-manajemen-perusahaan-dengan-aplikasi-odoo)
    ...
    - [IF3140 Manajemen Basis Data](#if3140-manajemen-basis-data)
      - [Tugas Besar 2 - Implementasi Database Concurrency Control dengan Simple Locking, OCC, dan MVCC](#tugas-besar-2---implementasi-database-concurrency-control-dengan-simple-locking-occ-dan-mvcc)
  ...
  - [Semester 6](#semester-6)
    - [IF3210 Pengembangan Aplikasi pada Platform Khusus](#if3210-pengembangan-aplikasi-pada-platform-khusus)
      - [Tugas Besar Android - Food Ordering App](#tugas-besar-android---food-ordering-app)
      - [Tugas Besar Unity - Extended Survival Shooter](#tugas-besar-unity---extended-survival-shooter)
    - [IF3270 Pembelajaran Mesin](#if3270-pembelajaran-mesin)
      - [Tugas Besar A - Forward Propagation](#tugas-besar-a---forward-propagation)
      - [Tugas Besar B - Backward Propagation](#tugas-besar-b---backward-propagation)
    - [IF3230 Sistem Paralel dan Terdistribusi](#if3230-sistem-paralel-dan-terdistribusi)
      - [Tugas Kecil 1 - Open MPI, Tugas Kecil 2 - Open MP, Tugas Kecil 3 - CUDA](#tugas-kecil-1---open-mpi-tugas-kecil-2---open-mp-tugas-kecil-3---cuda)
      - [Tugas Besar - Raft Protocol](#tugas-besar---raft-protocol)
    - [IF3250 Proyek Perangkat Lunak](#if3250-proyek-perangkat-lunak)
      - [Project CariDosen](#project-caridosen)
    - [IF3260 Grafika Komputer](#if3260-grafika-komputer)
      - [Tugas Besar 1 - WebGL 2D Web Based Computer Aided Design (CAD)](#tugas-besar-1---webgl-2d-web-based-computer-aided-design-cad)
      - [Tugas Besar 2 - WebGL 3D Hollow Object](#tugas-besar-2---webgl-3d-hollow-object)
      - [Tugas Besar 3 - WebGL 3D Articulated Model](#tugas-besar-3---webgl-3d-articulated-model)
    - [IF3280 Socio-informatika dan Profesionalisme](#if3280-socio-informatika-dan-profesionalisme)
      - [Tugas Resume Buku](#tugas-resume-buku)
...
- Address (IP dan port) akan menjadi identitas setiap node
- Implementasi awal adalah server-client dengan RPC sederhana
- Mengimplementasikan membership change
- Mengimplementasikan log replication
- Mengimplementasikan heartbeat
- Mengimplementasikan leader election
##### Useful links and resources
- [Raft Paper - Github Pages](https://raft.github.io/)
- [Original Raft Paper](https://raft.github.io/raft.pdf)
- [Raft visualization](http://thesecretlivesofdata.com/raft/)
- [Raft Wikipedia](https://www.wikiwand.com/en/Raft_(algorithm))
- [distribution system notes](https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/dist-sys-notes.pdf) 
##### Example projects
- [Repository](https://github.com/Sister19/if3230-tubes-spilltheteasis)

### IF3250 Proyek Perangkat Lunak
#### Project CariDosen
Pilih suatu topik project untuk dikerjakan selama 10 minggu. Gunakan metodologi scrum, project dikerjakan oleh 5 orang dan setiap orang akan menjadi scrum master selama 2 minggu. Terdapat stand up meeting selama 2 hari sekali untuk progress report. Di akhir sprint akan ada sprint review, untuk demonstrasi kepada product owner, dan sprint retrospective, untuk evaluasi keberjalanan sprint.
...
Website dengan fitur menggambar dan mengedit model pada kanvas menggunakan WebGL murni, tanpa library/framework tambahan. Model terdiri dari garis, persegi, persegi panjang, dan polygon.
##### User stories
  - [ ] Pengguna dapat menggambar model garis, persegi, persegi panjang, dan polygon
  - [ ] Pengguna dapat mengubah panjang garis
  - [ ] Pengguna dapat mengubah panjang sisi persegi
  - [ ] Pengguna dapat mengubah panjang atau lebar persegi panjang
  - [ ] Pengguna dapat menambah dan menghapus titik sudut
  - [ ] Pengguna dapat melakukan transformasi geometri (pilih 2 dari translasi, dilatasi, rotasi, shear)
  - [ ] Pengguna dapat menggerakkan titik sudut dengan drag and drop
  - [ ] Pengguna dapat mengubah warna titik sudut
  - [ ] Pengguna dapat menyimpan dapat menyimpan dan memuat model yang dibuat
##### Useful links and resources
...
Website visualisasi 3D hollow object merupakan versi tiga dimensi dari tugas besar 1. Kali ini model yang dibuat adalah objek berongga (hollow objects). 
##### User stories
  - [ ] Pengguna dapat mengubah jenis proyeksi objek (orthographic, oblique, atau perspective)
  - [ ] Pengguna dapat melakukan rotasi, translasi, dan scaling pada objek
  - [ ] Pengguna dapat menggubah jarak view kamera untuk menjauhi, mendekati, dan mengitari objek
  - [ ] Pengguna dapat menyimpan dan memuat model
  - [ ] Pengguna dapat mengaktifkan dan menonaktifkan shading pada model
  - [ ] Pengguna dapat menjalankan animasi pada model
##### Useful links and resources
- [WebGL Fundamentals](https://webglfundamentals.org/)
##### Example projects
